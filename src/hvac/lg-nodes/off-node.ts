 ...
 */
export async function offNode(state: HVACLangGraphState): Promise<HVACLangGraphState> {
...
async function performShutdownProcedures(state: HVACLangGraphState): Promise<{
  ...
  if (emergencyCheck.hasEmergency && emergencyCheck.emergencyType && emergencyCheck.message) {
 ...
 */
async function shutdownHVACEntities(state: HVACLangGraphState): Promise<boolean> {
  try {
 ...
 */
async function shutdownEntity(entityId: string): Promise<{ success: boolean; entityId: string }> {
 ...
 */
async function disableActiveOperations(state: HVACLangGraphState): Promise<boolean> {
 ...
 */
async function setupMinimalMonitoring(state: HVACLangGraphState): Promise<boolean> {
