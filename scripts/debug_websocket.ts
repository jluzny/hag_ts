...
try {
  ...
  try {
    ...
    console.log(
      `❌ Indoor temp error: ${error instanceof Error ? error.message : String(error)}`,
    );
  }
  ...
  try {
    ...
    console.log(
      `❌ Outdoor temp error: ${error instanceof Error ? error.message : String(error)}`,
    );
  }
