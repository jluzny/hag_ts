...
export class ValidationHelper {
   ...
   */
  displayResults(title: string, results: Array<{name: string, status: boolean, details?: string}>) {
    console.log(`\n📊 ${title}`);
...
export class HealthChecker {
   ...
   */
  async checkSystemRequirements(): Promise<{name: string, status: boolean, details: string}[]> {
    const results = [];
   ...
   */
  async checkNetworkConnectivity(): Promise<{name: string, status: boolean, details: string}[]> {
    const results = [];
...
export class ConfigValidator {
   ...
   */
  async validateConfigFile(configPath: string): Promise<{name: string, status: boolean, details: string}[]> {
    const results = [];
