...
Deno.test('Performance Optimizer', async (t) => {
  ...
  await t.step('should handle metrics history', async () => {
    ...
    optimizer.recordMetrics({ memoryUsage: 100, cpuUsage: 30, averageResponseTime: 100 });
    optimizer.recordMetrics({ memoryUsage: 120, cpuUsage: 40, averageResponseTime: 110 });
    optimizer.recordMetrics({ memoryUsage: 140, cpuUsage: 50, averageResponseTime: 120 });
